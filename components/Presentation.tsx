  ...
  return (
    <div className="flex h-screen w-full overflow-hidden bg-white text-black">
      ...
      <aside className="w-64 border-r-2 border-black flex flex-col justify-between p-8 shrink-0 bg-white z-10">
        <div>
          <h1 className="text-2xl font-black tracking-tighter mb-20 uppercase">
            AI Product Flow
          </h1>
          ...
          <motion.div
            ...
            className={
              activeSlide.type === "pipeline"
                ? "max-w-7xl w-full mx-auto pt-12 pb-12 px-20"
                : "max-w-7xl w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-24 items-start pt-24 pb-24 px-20"
            }
          >
            {activeSlide.type === "pipeline" ? (
